      ...
      <DefaultLayout>
        ...
        <section className="text-gray-600 body-font bg-white rounded-lg shadow-lg">
          {profileData.map((item) => (<>
            ...
            <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center w-fit" key={item._id}>
              {item.logo ?
                <div className="lg:max-w-lg lg:w-36 md:w-36 w-5/6 mb-10 md:mb-0">
                  ...
                  <Image src={imgLogo[0]} width={250} height={250} alt={"logo"} className="object-cover object-center rounded outline-gray-500 outline p-5" />
